...
googletag.cmd.push(function() {
    ...
    window.GAMLibrary.exposer = googletag.defineSlot(GAMLibrary.gamExposer1, [[300, 250], [300, 600], [320, 480], [160, 600], [250, 250]], 'div-gpt-ad-bola-dfp-exposer-slot1-oop').addService(googletag.pubads());
    ...
    /* REFRESH ON DEMAND */
    googletag.pubads().refresh([window.GAMLibrary.interstitial, window.GAMLibrary.showcase, window.GAMLibrary.exposer, window.GAMLibrary.topframe, window.GAMLibrary.crmHeadline, window.GAMLibrary.crmOrganic1, window.GAMLibrary.crmOrganic2, window.GAMLibrary.crmOrganic3, window.GAMLibrary.pictureFirst, window.GAMLibrary.slideup, window.GAMLibrary.widget]);
