            ...
            if (scrollTop >= this.articleType[pageType].scroll) {
                if (!this.timedFloatingPin) {
                    this.timedFloatingPin = googletag.defineSlot(this.dfpFloatingPin, [
                        [1, 1],
                        ['fluid']
                    ], 'div-gpt-ad-kapanlagi-floating-pin').addService(googletag.pubads()).setTargeting('pagingNum', '1');
...
googletag.cmd.push(function() {
    ...
    if (GAMLibrary.topFrameFixedSize) {
        window.GAMLibrary.topframe = googletag.defineSlot(GAMLibrary.dfpTopframe, [1, 1], 'div-gpt-ad-topfrm').addService(googletag.pubads()).setTargeting('pagingNum', '1');
    } else {
...
function showAds(adsContainer, size, adunit) {
    if (adsContainer && size && adunit) {
        if (adunit === "dfp-sc") {
            ...
            adunit = "HEADLINE";
        } else if (adunit === "dfp-exposer-slot1") {
            adunit = "EXPOSER";
        }
        ...
        /*making adrequest*/
        googletag.cmd.push(function() {
            /*googletag.pubads().clearTargeting('pagingNum');*/
