...
var adUnitsDisplay = [{
        ...
        bids: [
            ...
            { bidder: "oftmedia", params: { placementId: "27497187" } },
            ...
            { bidder: "triplelift", params: { inventoryCode: 'Bola-net_Mobile_300x250_Pubmatic' } },
        ],
    },
    {
        ...
        bids: [
            ...
            { bidder: 'smartadserver', params: { domain: 'https://prg-apac.smartadserver.com', networkId: 4221, siteId: 498330, pageId: 1556522, formatId: 111312 } },
            { bidder: "openx", params: { delDomain: "emtek-d.openx.net", unit: "556894068" } },
            { bidder: 'ix', params: { siteId: '802738' } },
            { bidder: "teads", params: { pageId: 153497, placementId: 167809 } },
            { bidder: "oftmedia", params: { placementId: "27497186" } },
            { bidder: "yahoossp", params: { dcn: '8a969d80018383b1b722c66620e1024f', pos: '8a969d80018383b1b722c666d6050251' } },
            { bidder: "taboola", params: { tagId: 'headline_homepage_1', publisherId: '1501401', } },
            { bidder: "triplelift", params: { inventoryCode: 'Bola-net_HDX_Pubmatic' } },
        ],
    },
    {
        ...
        bids: [
            ...
            { bidder: 'smartadserver', params: { domain: 'https://prg-apac.smartadserver.com', networkId: 4221, siteId: 498330, pageId: 1556522, formatId: 111312 } },
            { bidder: "openx", params: { delDomain: "emtek-d.openx.net", unit: "556894064" } },
            { bidder: 'ix', params: { siteId: '802749' } },
            { bidder: "teads", params: { pageId: 151772, placementId: 167811 } },
            { bidder: "oftmedia", params: { placementId: "27497188" } },
            { bidder: "yahoossp", params: { dcn: '8a969d80018383b1b722c66620e1024f', pos: '8a9695bc018383b1c995c6672692025e' } },
            { bidder: "taboola", params: { tagId: 'bottomfrm_homepage_1', publisherId: '1501401', } },
            { bidder: "triplelift", params: { inventoryCode: 'Bola-net_HDX_Pubmatic' } },
        ],
    },
    {
        ...
        bids: [
            ...
            { bidder: 'ix', params: { siteId: '802748' } },
            { bidder: "oftmedia", params: { placementId: "27497189" } },
            { bidder: "yahoossp", params: { dcn: '8a969d80018383b1b722c66620e1024f', pos: '8a96908c018383b1ce9ac66698bf024a' } },
            { bidder: "taboola", params: { tagId: 'exposer_homepage_1', publisherId: '1501401', } },
            { bidder: "triplelift", params: { inventoryCode: 'Bola-net_Mobile_300x250_Pubmatic' } },
        ],
    },
];
...
var gpt_gam_site = window.location.hostname.toUpperCase(),
    gpt_gam_ver = 'V3.3-ADS';

/*SET INTERVAL TO AUTO REFRESH BOTTOM FRAME ADS - NEW*/
window.GAMLibrary = {};
window.GAMLibrary = {
    dfpHeadline: '/36504930/KLY/MOBILE/BOLA.NET/HEADLINE',
    dfpBottomframe: '/36504930/KLY/MOBILE/BOLA.NET/BOTTOM_FRAME',
    dfpFloatingPin: '/36504930/KLY/MOBILE/BOLA.NET/FLOATING_PIN',
    dfpTopframe: '/36504930/KLY/MOBILE/BOLA.NET/MASTHEAD',
    dfpExposer1: '/36504930/KLY/MOBILE/BOLA.NET/EXPOSER',
    dfpSlideup: '/36504930/KLY/MOBILE/BOLA.NET/SLIDE_UP',
    scSlot: '/36504930/KLY/MOBILE/BOLA.NET/SHOWCASE',
    timedBottomFrm: null,
    ...
    setGamBFInterval: function(active = true) {
        ...
        window.GAMLibrary.gamBFInterval = setInterval(function() {
            ...
            pbjs.setTargetingForGPTAsync(['div-gpt-ad-bola-bottomfrm']);
    ...
    initiateSCReadPage: function() {
        ...
        if (placeHolderlement) {
            placeHolderlement.forEach((placeholder, index) => {
                let SC = null;
                let containerID = "gpt-ad-bola-sc-" + (index + 1);
                ...
                if (SC = googletag.defineSlot('/36504930/KLY/MOBILE/BOLA.NET/SHOWCASE', [
                        [300, 250],
                        [250, 250],
                        [200, 200]
                    ], containerID)) {
                    ...
                    setTimeout(() => {
                        if (pbjs) {
                            pbjs.setTargetingForGPTAsync(['div-gpt-ad-bola-sc']);
                        }
                    }, 400);
    ...
    activateHeadlineV2: function() {
            if (!this.headline) {
                ...
                if (pbjs) {
                    pbjs.setTargetingForGPTAsync(['div-gpt-ad-bola-hl']);
                }
...
googletag.cmd.push(function() {
    ...
    if (GAMLibrary.topFrameFixedSize) {
        window.GAMLibrary.topframe = googletag.defineSlot(GAMLibrary.dfpTopframe, [1, 1], 'div-gpt-ad-bola-topfrm-oop').addService(googletag.pubads());
    } else {
        window.GAMLibrary.topframe = googletag.defineOutOfPageSlot(GAMLibrary.dfpTopframe, 'div-gpt-ad-bola-topfrm-oop').addService(googletag.pubads());
    }
...
function headlineStickyV2(a) {
    ...
    var b = document.getElementById("div-gpt-ad-bola-hl"),
        c = document.createElement("div");
    !document.getElementById("div-gpt-ad-bola-hl-shadow") ? (c.setAttribute("id", "div-gpt-ad-bola-hl-shadow"), b.parentElement.insertBefore(c, b)) : '', injectStickyStyleAndAnimationV2(), window.addEventListener("scroll", headlineStickyScrollEventV2)
}

function headlineStickyScrollEventV2() {
    var a = document.getElementById("div-gpt-ad-bola-hl").firstElementChild,
        b = document.getElementById("div-gpt-ad-bola-hl-shadow").getBoundingClientRect().top;
...
function headlineSticky(a) {
    ...
    var b = document.getElementById("div-gpt-ad-bola-hl"),
        c = document.createElement("div");
    c.setAttribute("id", "div-gpt-ad-bola-hl-shadow"), b.parentElement.insertBefore(c, b), injectStickyStyleAndAnimation(), window.addEventListener("scroll", headlineStickyScrollEevent)
}
...
function _GET_TARGET_() {
    ...
    childs && childs.forEach(el => {
        if (el.parentElement.tagName == 'BODY') {
            ...
            if (el.nextElementSibling.classList.length == 0) {
                _CHILDS_.push(el.nextElementSibling);
            }
        }
    });
    if (parentType1) {
        _NAVBAR_ = document.querySelector("#main_top");
        if (_NAVBAR_) {
            customContainer.classList.add('ads-container');
            _NAVBAR_.insertAdjacentElement('beforebegin', customContainer);
            _MAIN_ = parentType1;
        }
    } else if (parentType2) {
        _NAVBAR_ = document.querySelector(".header");
        if (_NAVBAR_) {
    ...
    _PARENT_BODY_TARGET_ = customContainer;
}
...
function _TOPFRAME_STICKY_TWEAK_() {
    _MAIN_ && _PARENT_BODY_TARGET_.insertAdjacentElement('afterbegin', _MAIN_);
    _PARENT_BODY_TARGET_.insertAdjacentElement('afterbegin', _NAVBAR_);
    if (_CHILDS_.length > 0) {
        _CHILDS_.forEach(el => {
            _PARENT_BODY_TARGET_.lastChild.insertAdjacentElement('afterend', el);
        })
    }
    setTimeout(() => {
...
function _INSERTPICTUREFIRST_() {
    var _PICTUREFIRST_ = document.createElement("div")
    _PICTUREFIRST_.setAttribute("id", "div-gpt-ad-bola-picturefirst")
    _PICTUREFIRST_.setAttribute("data-info", "ad")

    var _PUSHPICTUREFIRST = document.createElement("script")
    _PUSHPICTUREFIRST.textContent = `googletag.cmd.push(function() { googletag.display('div-gpt-ad-bola-picturefirst'); });`
    _PICTUREFIRST_.appendChild(_PUSHPICTUREFIRST)

    var _PICTUREFIRSTTARGET_ = (kly.pageType.toLowerCase() != 'readpage') ? document.getElementById("main_mid_lastest") : document.querySelector(".box-tag");
    if (_PICTUREFIRSTTARGET_) {
        _PICTUREFIRSTTARGET_.parentElement.insertBefore(_PICTUREFIRST_, _PICTUREFIRSTTARGET_.nextElementSibling)
    }
}

window.addEventListener('DOMContentLoaded', _INSERTPICTUREFIRST_);
