...
var gpt_gam_site = window.location.hostname.toUpperCase(),
    gpt_gam_ver = 'V3.2-ADS';

/*SET INTERVAL TO AUTO REFRESH BOTTOM FRAME ADS - NEW*/
window.dataLayer = window.dataLayer || [];
window.GAMLibrary = {};
window.GAMLibrary = {
    dfpHeadline: '/36504930/KLY/MOBILE/DREAM.CO.ID/HEADLINE',
    ...
    dfpSlideup: '/36504930/KLY/MOBILE/DREAM.CO.ID/SLIDE_UP',
    dfpExposer1: '/36504930/KLY/MOBILE/DREAM.CO.ID/EXPOSER',
    dfpExposer2: '/36504930/m.dream.co.id/dfp-exposer-slot2',
    scSlot: '/36504930/KLY/MOBILE/DREAM.CO.ID/SHOWCASE',
    timedBottomFrm: null,
    ...
    setGamBFCloseBtn: function() {
        ...
        buttonCloseBframeClick.setAttribute("style", "width: 20px; position: absolute; margin-left: 150px; top: -15px; z-index: 99999;");
            ...
            if (scrollTop >= this.articleType[pageType].scroll) {
                if (!this.timedBottomFrm) {
                    this.timedBottomFrm = googletag.defineSlot(this.dfpBottomframe, [
                        [320, 50],
                        [320, 100]
                    ], 'div-gpt-ad-dream-bottomfrm').addService(googletag.pubads());
                    setTimeout(() => {
                        if (pbjs) {
                            pbjs.setTargetingForGPTAsync(['div-gpt-ad-dream-bottomfrm']);
            ...
            if (scrollTop >= this.articleType[pageType].scroll) {
                if (!this.timedFloatingPin) {
                    this.timedFloatingPin = googletag.defineSlot(this.dfpFloatingPin, [
                        [1, 1],
                        ['fluid']
                    ], 'div-gpt-ad-dream-floating-pin').addService(googletag.pubads());
        ...
        mo = new MutationObserver(function(mutations) {
            mutations.forEach(function(el) {
                ...
                if (isShown && el.attributeName === 'data-pushed') {
                    ...
                    gam_sc = googletag.defineSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/SHOWCASE', [
                        [300, 600],
                        [300, 250],
                        [250, 250],
                        [200, 200]
                    ], showcaseId + countShowcaseContainer).addService(googletag.pubads()).setTargeting("position", [countShowcaseContainer.toString()]);
                    googletag.display(showcaseId + countShowcaseContainer);
                    pbjs.setTargetingForGPTAsync(['div-gpt-ad-dream-sc']);
    ...
    exposerInterscroller: function(event) {
        ...
        if (_is300x250_ && _domId_.includes("exposer")) {
            _domTarget_.firstElementChild.classList.add("interscroller");
            _domTarget_.classList.add("interscroller-wrapper");
        }
    },
    exposerInterscrollerStyle: function() {
        var interscrollerStyle = document.createElement("style");
        interscrollerStyle.textContent = ".interscroller-wrapper{display: block !important; min-height: 600px;} .interscroller{position: sticky; top: 160px;}";
    ...
    _SCFlyingCarpetStyle_: function() {
        ...
        _style_.textContent = `.banner div[id*="dream-sc"].flying-carpet, div[id*="dream-showcase"].flying-carpet { position: relative; clear: both; overflow: hidden; clip-path: polygon(0px 0px, 100% 0px, 100% 100%, 0px 100%) !important; min-height: 270px; width: 100%; display: flex; justify-content: center; } .banner div[id*="dream-sc"].flying-carpet .ad-content, div[id*="dream-showcase"].flying-carpet .ad-content { top: 50%; transform: translateY(-50%); position: fixed; z-index: 2; }`;
    ...
    renderHeadlineV2: function() {
        let hlv1 = document.getElementById("div-gpt-ad-dream-hl");
    ...
    injectHeadlineV2: function() {
        let headlineSlotContainer = document.querySelector("#div-gpt-ad-dream-hl");
    ...
    activateHeadlineV2: function() {
        if (!this.headline) {
            ...
            if (pbjs) {
                pbjs.setTargetingForGPTAsync(['div-gpt-ad-dream-hl']);
            }
...
googletag.cmd.push(function() {
    ...
    if (GAMLibrary.topFrameFixedSize) {
        window.GAMLibrary.topframe = googletag.defineSlot(GAMLibrary.dfpTopframe, [1, 1], 'div-gpt-ad-dream-topfrm-oop').addService(googletag.pubads());
    } else {
        window.GAMLibrary.topframe = googletag.defineOutOfPageSlot(GAMLibrary.dfpTopframe, 'div-gpt-ad-dream-topfrm-oop').addService(googletag.pubads());
    }
    ...
    window.GAMLibrary.newsTag1 = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/NEWS_TAG_1', 'div-gpt-ad-dream-newsTag1-oop').addService(googletag.pubads());
    window.GAMLibrary.newsTag2 = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/NEWS_TAG_2', 'div-gpt-ad-dream-newsTag2-oop').addService(googletag.pubads());
    // window.GAMLibrary.exposer2 = googletag.defineOutOfPageSlot(GAMLibrary.dfpExposer2, 'div-gpt-ad-dream-dfp-exposer-slot2').addService(googletag.pubads());
    ...
    window.GAMLibrary.crmHeadline = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/HEADLINE_CRM', 'div-gpt-ad-dream-crm-headline-oop').addService(googletag.pubads());
    window.GAMLibrary.crmOrganic1 = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/ORGANIC_FEED_CRM_1', 'div-gpt-ad-dream-crm1-oop').addService(googletag.pubads());
    window.GAMLibrary.crmOrganic2 = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/ORGANIC_FEED_CRM_2', 'div-gpt-ad-dream-crm2-oop').addService(googletag.pubads());
    window.GAMLibrary.crmOrganic3 = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/ORGANIC_FEED_CRM_3', 'div-gpt-ad-dream-crm3-oop').addService(googletag.pubads());
    window.GAMLibrary.pictureFirst = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/CONTENT_CAROUSEL', 'div-gpt-ad-dream-picturefirst').addService(googletag.pubads());

    if (isReadPage) {
        window.GAMLibrary.insertion = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/INSERTION', 'div-gpt-ad-dream-insertion-oop').addService(googletag.pubads());
        window.GAMLibrary.inreadnative = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/IN-READ_NATIVE', 'div-gpt-ad-dream-in-read-native').addService(googletag.pubads());
    } else if (kly.pageType === "Homepage") {
        window.GAMLibrary.advHeadline1 = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/ADVERTORIAL_HEADLINE_1', 'div-gpt-ad-dream-advertorial-headline1').addService(googletag.pubads());
        window.GAMLibrary.advHeadline2 = googletag.defineOutOfPageSlot('/36504930/KLY/MOBILE/DREAM.CO.ID/ADVERTORIAL_HEADLINE_2', 'div-gpt-ad-dream-advertorial-headline2').addService(googletag.pubads());
    }
    ...
    /* REFRESH ON DEMAND */
    googletag.pubads().refresh([window.GAMLibrary.topframe, window.GAMLibrary.newsTag1, window.GAMLibrary.newsTag2, window.GAMLibrary.overlay, window.GAMLibrary.crmHeadline, window.GAMLibrary.crmOrganic1, window.GAMLibrary.crmOrganic2, window.GAMLibrary.crmOrganic3, window.GAMLibrary.pictureFirst]);
    if (isReadPage) {
...
function headlineStickyV2(a) {
    ...
    var b = document.getElementById("div-gpt-ad-dream-hl"),
        c = document.createElement("div");
    !document.getElementById("div-gpt-ad-dream-hl-shadow") ? (c.setAttribute("id", "div-gpt-ad-dream-hl-shadow"), b.parentElement.insertBefore(c, b)) : '', injectStickyStyleAndAnimationV2(), window.addEventListener("scroll", headlineStickyScrollEventV2)
}

function headlineStickyScrollEventV2() {
    var a = document.getElementById("div-gpt-ad-dream-hl").firstElementChild,
        b = document.getElementById("div-gpt-ad-dream-hl-shadow").getBoundingClientRect().top;
...
function headlineSticky(a) {
    ...
    var b = document.getElementById("div-gpt-ad-dream-hl"),
        c = document.createElement("div");
    c.setAttribute("id", "div-gpt-ad-dream-hl-shadow"), b.parentElement.insertBefore(c, b), injectStickyStyleAndAnimation(), window.addEventListener("scroll", headlineStickyScrollEevent)
}
